/**
 * TypeScript port of PopupDependencyGraph.tsx
 * Recoil DevTools browser extension.
 */

import {createSankeyData} from '../../utils/GraphUtils';
import Sankey from '../../utils/sankey/Sankey';
import {
  butterflyGraphLayout,
  flowGraphLayout,
} from '../../utils/sankey/SankeyGraphLayout';
...
function PopupDependencyGraph(): React.ReactNode {
    ...
    <>
      ...
      <div style={styles.graph}>
        <Sankey
          ...
          links={{
            data: edges,
            getLinkValue: (l: any) => l.value,
            getLinkSourceKey: (l: any) => l.source,
            getLinkTargetKey: (l: any) => l.target,
          }}
          nodeStyles={{
            fill: n => {
          ...
          nodeEvents={{
            click: (node: any) => setFocalNodeKey(node?.key),
          }}
          layout={layout}
          nodeThickness={20}
...
export default PopupDependencyGraph;

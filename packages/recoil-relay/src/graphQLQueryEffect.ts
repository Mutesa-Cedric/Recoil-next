...
function subscribeToLocalRelayCache<TVariables extends Variables, TData extends Record<string, any>>(
...
interface GraphQLQueryEffectOptions<TVariables extends Variables, TData extends Record<string, any>, T> {

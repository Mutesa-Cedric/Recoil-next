...
interface GraphQLMutationEffectOptions<T, TVariables extends Variables, TResponse extends Record<string, any>> {
                    ...
                    onError: (error: Error) => {
                        ...
                        if (mutationID === currentMutationID) {
                            setSelf((potentiallyBadValue: T | DefaultValue) =>
                                ...
                                potentiallyBadValue === newValue ? oldValue : potentiallyBadValue,
                            );
                        }
                    },

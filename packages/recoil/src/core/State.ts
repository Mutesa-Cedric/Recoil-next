...
import { RecoilLoadable, Loadable } from '../adt/Loadable'; // eslint-disable-line no-unused-vars – used in type positions
...
export interface Store {
    ...
    subscribeToTransactions(callback: (store: Store) => void, nodeKey?: NodeKey): { release: () => void };
...
export function makeEmptyStoreState(): StoreState {
    ...
    return {
        ...
        graphsByVersion: new Map<StateID, Graph>().set(currentTree.version, makeGraph()),
        retention: {
